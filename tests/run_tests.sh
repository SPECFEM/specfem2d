...
# relative location of SPECFEM2D root directory for tests directories (e.g. SPECFEM2D/tests/compilations)
export ROOT=../../
...
if [ ! -e "${ROOT}/src/specfem2D/specfem2D.F90" ]; then echo "please check if ROOT set correctly ..."; exit 1; fi
