...
!========================================================================
  ...
  subroutine plot_post(displ,coord,ibool,NGLOB,NSPEC,x_source,z_source,st_xval,st_zval,it,deltat,NGLLX,NGLLZ,NDIM,nrec)
...
!
  ...
  do irec = 1,nrec
    if (irec == 1) write(24,*) '% beginning of receiver line'
    if (irec == nrec) write(24,*) '% end of receiver line'
