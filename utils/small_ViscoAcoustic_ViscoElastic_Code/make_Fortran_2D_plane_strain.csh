...
#gfortran -O3 -std=f2003 -fimplicit-none -frange-check -fmax-errors=10 -pedantic -pedantic-errors -Waliasing -Wampersand -Wcharacter-truncation -Wline-truncation -Wsurprising -Wno-tabs -Wunderflow -ffpe-trap=invalid,zero,overflow -Wunused -Werror -o xspecfem2D specfem2D_plane_strain.f90 plot_post.f90 createnum_slow.f90 locate_receivers.F90 define_derivation_matrices.f90 recompute_jacobian.f90 define_shape_functions.f90 gll_library.f90 lagrange_poly.f90 elastic_forcing_routines.f90 attenuation_model.f90 small_specfem_par.f90 compute_forces.f90

# with full debugging turned on
gfortran -std=f2003 -fimplicit-none -frange-check -fmax-errors=10 -pedantic -pedantic-errors -Waliasing -Wampersand -Wcharacter-truncation -Wline-truncation -Wsurprising -Wno-tabs -Wunderflow -ffpe-trap=invalid,zero,overflow -Wunused -Werror -g -O0 -ggdb -fbacktrace -fbounds-check -o xspecfem2D specfem2D_plane_strain.f90 plot_post.f90 createnum_slow.f90 locate_receivers.F90 define_derivation_matrices.f90 recompute_jacobian.f90 define_shape_functions.f90 gll_library.f90 lagrange_poly.f90 elastic_forcing_routines.f90 attenuation_model.f90 small_specfem_par.f90 compute_forces.f90
