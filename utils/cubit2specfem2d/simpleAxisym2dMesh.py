...
cubit.cmd('block 100 name "pml_z_elast"')
...
cubit.cmd('block 101 name "pml_x_elast"')
...
cubit.cmd('block 102 name "pml_xz_elast"')
...
cubit.cmd('delete face all except face in block all') # Delete all other faces
