...
// compute_seismograms
 ...
 switch (seismotype){
  ...
  if (! *any_elastic_glob) printf("\nWrong type of seismogram for a pure elastic simulation, use pressure in seismotype\n");
 ...
 case 4 :  //Pression
  ...
  if (! *any_acoustic_glob) printf("\nWrong type of seismogram for a pure fluid simulation, use displ veloc or accel in seismotype\n");
