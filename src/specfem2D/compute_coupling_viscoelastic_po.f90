...
! for viscoelastic solver
  ...
  do inum = 1,num_solid_poro_edges
    ...
    do ipoin1D = 1,NGLLX
      ...
      mul_unrelaxed_elastic = mustore(ii2,jj2,ispec_elastic)
      rhol = rhostore(ii2,jj2,ispec_elastic)
      cpl = rho_vpstore(ii2,jj2,ispec_elastic) / rhol
      ...
      if (ispec_is_anisotropic(ispec_elastic)) then
        ...
        c11 = c11store(ii2,jj2,ispec_elastic)
        c12 = c12store(ii2,jj2,ispec_elastic)
        c13 = c13store(ii2,jj2,ispec_elastic)
        c15 = c15store(ii2,jj2,ispec_elastic)
        c23 = c23store(ii2,jj2,ispec_elastic)
        c25 = c25store(ii2,jj2,ispec_elastic)
        c33 = c33store(ii2,jj2,ispec_elastic)
        c35 = c35store(ii2,jj2,ispec_elastic)
        c55 = c55store(ii2,jj2,ispec_elastic)
...
! for viscoelastic solver
  ...
  do inum = 1,num_solid_poro_edges
    ...
    do ipoin1D = 1,NGLLX
      ...
      ! get poroelastic domain parameters
      phi = phistore(i,j,ispec_poroelastic)
      kappa_s = kappaarraystore(1,i,j,ispec_poroelastic)
      kappa_f = kappaarraystore(2,i,j,ispec_poroelastic)
      kappa_fr = kappaarraystore(3,i,j,ispec_poroelastic)
