...
following symbol: \includegraphics[width=0.15in]{figures/play_journal_file}. Then select the
...
\end{verbatim}
It will create a simple mesh with PMLs. Then re-click on \includegraphics[width=0.15in]{figures/play_journal_file} and
play:
\begin{verbatim}
...
Another commented examples are available: \texttt{EXAMPLES/TODOpaper}, \texttt{EXAMPLES/TODOnonDestructiveTesting}. %TODO!!
...
\begin{figure}[htbp]
\centering
\includegraphics[width=6in]{figures/how_to_use_PML_with_external_velocity_model}
