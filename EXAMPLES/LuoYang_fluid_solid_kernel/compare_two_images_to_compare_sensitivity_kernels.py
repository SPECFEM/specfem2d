...
image_original_reference = "rho_and_kappa_kernels_acoustic_and_elastic_only_no_caption_reference.png"
image_from_new_calculation = "rho_and_kappa_kernels_acoustic_and_elastic_only_no_caption.png"
