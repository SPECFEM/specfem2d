...
!no solvopt
  ...
  tau_sigma_nu2 =   (/8.841941282883074E-002,  2.796067339138169E-002,  8.841941282883075E-003,  2.796067339138169E-003,  8.841941282883074E-004/)

! tau_epsilon_nu1 = (/9.589259450019638E-002,  4.441026328082600E-002, &
!  2.479055049430942E-002,  1.251318924641243E-002,  6.373006321777268E-003, &
!  3.512305736505357E-003,  1.620280725109021E-003, 9.799043191573951E-004/)
...
! tau_epsilon_nu2 =   (/9.673241772597907E-002,  4.428660266615121E-002, &
!  2.489863218879534E-002,  1.255573373325101E-002,  6.366935017987694E-003, &
!  3.544893266267576E-003,  1.606542856878940E-003,  9.937392550381586E-004/)
! tau_sigma_nu2 =   (/8.841941282883074E-002,  4.579660964308235E-002, &
!  2.372023730649557E-002,  1.228583733319689E-002,  6.363417714226235E-003, &
!  3.295916221662683E-003,  1.707111528437532E-003,  8.841941282883074E-004/)

! tau_epsilon_nu1 =  (/9.545531346703773E-002,  9.461389880216844E-003, 9.669690969548052E-004/)
! tau_sigma_nu1 =   (/8.841941282883074E-002,  8.841941282883075E-003, 8.841941282883074E-004/)
! tau_epsilon_nu2 =   (/9.628897007987923E-002,  9.540902398370342E-003, 9.785205613505599E-004/)
...
!  tau_sigma_nu1   =    (/3.876976972195918E-002, 1.669539210862250E-003/)
...
! in which waves speed up when attenuation is turned on
  if (FIX_ATTENUATION_CAUSALITY) then
    ...
    M1C = (M1_unrelaxed /(1.d0 - Lnu + sum(tau_epsilon_nu1(:)/tau_sigma_nu1(:))) &
        * (1.d0 - Lnu + temp ))
    ...
    M2C = (M2_unrelaxed /(1.d0 - Lnu+sum(tau_epsilon_nu2(:)/tau_sigma_nu2(:))) &
        * (1.d0 - Lnu + temp ))
